        ...
        <div>
			<div class="row">
				...
				<div class="intro-text">
					<div class="intro-heading video-container"><iframe src="https://www.youtube.com/embed/lYohowSk2-8" frameborder="0" allowfullscreen></iframe></div>
				</div>
			</div>
			<div class="row contact-us-row">
				<div class="my-hr"></div>
				<div class="header-subsection text-center">
					<div class="intro-subtext apex-adhd col-lg-6" style="text-align:justify;">
						All of our programs are conducted via Skype or over the phone so you can receive coaching from us anywhere in the world
						from the comfort of your own home. This also let's us get you into action on achieving your goals DURING the coaching
						session!
					</div>
					<div class="intro-action col-lg-offset-1 col-lg-5">
						<div class="h3 intro-contact">Get my <strong>FREE</strong> 1 Hour Coaching Session</div>
						<div class="h3 intro-contact text-center">
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<ul class="left-align-list">
									...
									<li>Create your own easy meal plans for you and your family</li>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<ul class="left-align-list">
									<li>Work with a coach to discover ways to make writing resumes, cover letters, and applications easy and less time consuming!</li>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted">
									It can be very exhausting to feel like you are unable to completely understand your loved one and give them the support they need.
									Especially when when your loved one doesn’t seem to want your help or is unwilling to change habits to help them manage their ADHD symptoms.
									We use our coaching experience from working with ADHD clients, to teach you all about the science behind ADHD and its symptoms.
									And because you’ll be working with a coach, and guide you in creating personalized strategies based on your loved one’s specific needs and challenges to
									help you give them the assistance to keep them moving forward towards their goals. In this coaching program, you will:
								</p>
								<ul class="left-align-list">
									<li>Learn about the neuroscience behind your specific ADHD symptom</li>
									<li>Work with your coach to create personalized tools to help you learn how to manage your ADHD symptom</li>
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<ul class="left-align-list">
									...
									<li>Work with a coach to develop your own exercise plan that you can actually follow through on</li>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<ul class="left-align-list">
									<li>Learn how to keep yourself calm in the midst of big life changes</li>
									<li>Reduce overwhelm and anxiety</li>
									<li>Simplify your life so that you can get everything on your to do list done</li>
									<li>Work with your coach to create personalized routines and systems to keep your life moving forward</li>
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<ul class="left-align-list">
									...
									<li>Work with your coach to develop personalized study strategies to help you get the most out of your study time!</li>
									<li>Study for LESS time, while absorbing MORE information!</li>
									...
									chores, paying rent) on top of balancing your classes and spend less time on thos errands so you have more time to
                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
								...
								<ul class="left-align-list">
									...
									<li>Work with a coach to find ways to communicate that will have you be heard and acknowledged by the people most important to you</li>
									<li>Understand challenges related to ADHD that get in the way of communicating effectively</li>
...
<script>
	...
	import programBox from './ProgramBox.vue'
	export default{
		components:{programBox}
	}
</script>
