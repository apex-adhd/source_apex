		...
		<div id="portfolio" class="box">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					...
					<div class="portfolio-caption">
						...
						<p class="text-muted">
						Do you feel like your home is filled with chaos and clutter the minute you walk through the door?
						</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					...
					<div class="portfolio-caption">
						...
						<p class="text-muted">
							...
							way to help them? Exhausted from asking them to get support or coaching and having them be unwilling to make changes?					
						</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					...
					<div class="portfolio-caption">
						<h4>Find Love in the Middle of a Scattered and Busy Life</h4>
						<p class="text-muted">
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#loseJob" class="portfolio-link" data-toggle="modal">
						...
						<img src="../assets/img/17474731_10155195409314549_1959763394_n.jpg" class="img-responsive" alt>
					</a>
					<div class="portfolio-caption">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#adhdSymptom" class="portfolio-link" data-toggle="modal">
						...
						<img src="../assets/img/17496080_10155195394819549_69347784_n.jpg" class="img-responsive" alt>
					</a>
					<div class="portfolio-caption">
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#relationships" class="portfolio-link" data-toggle="modal">
						...
						<img src="../assets/img/17467771_10155195385309549_1040223351_n.jpg" class="img-responsive" alt>
					</a>
					<div class="portfolio-caption">
						<h4>I Am So Tired of Drama in All My Relationships! Help Me Communicate!</h4>
						<p class="text-muted">
							Having trouble communicating with your Partner? Children? Siblings? Parents? Co-Workers? Friends? <strong>Everyone?</strong>
						</p>
					</div>
				</div>
			</div>
